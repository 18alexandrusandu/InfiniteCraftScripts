 // ==UserScript==
      ...
      (function() {
        var EMOJIS      = {}
        let modes       = ["None","Emoji simple","Emoji gradient","Emoji blend","One color","Saved Color","Reset Colors","Test","Soup Alphabeth","Moving Gradients","Chnaging colors"];
        let mode        = 1;
        const NoneMode=0;
               ...
               case 10:
                 {
                   ...
                   node.style.animation    = "change-colors 8s  infinite  linear running";
                   node.style.borderWidth  = "4px";
                   node.style.borderImage     = "";
                   node.style.backgroundImage = "";
