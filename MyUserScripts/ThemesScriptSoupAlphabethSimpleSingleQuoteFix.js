...
// ==UserScript==
       // @name        Chromatic Themes Changing Colors and Sparkles v200+
            ...
            case 8:
               ...
               if(!node.querySelector(".addspan"))
                  ...
                  let saveAgainText  = saveText;
                       console.log("TEXT:",saveText,":DONE");
                  ...
                  let text           = null;
                       if(saveAgainText!="\"")
                         {
                              text=node.innerHTML.replaceAll(saveAgainText,modified);
                            node.innerHTML = text;

                         }else
                           {
                          console.log(node.innerHTML.lastIndexOf(saveAgainText));
