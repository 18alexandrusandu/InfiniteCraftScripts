...
function getSave() {
    ...
    window.addEventListener('load', async () => {
                          ...
                          if(save!=null)
                            {
                              ...
                              if(!(a.text in save["recipes"]))
                               ...
                               if(!(b.text in save["recipes"]))
                                 return -1;
                                return  save["recipes"][b.text].length-save["recipes"][a.text].length;
                               })
      ...
      button.appendChild(document.createTextNode("Fetch savefile for sorting desc"));
