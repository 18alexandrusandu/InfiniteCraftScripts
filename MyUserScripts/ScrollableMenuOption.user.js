 // ==UserScript==
       // @name        Chromatic Themes Changing Colors and Sparkles v100+
      ...
      (function() {
        var EMOJIS      = {}
        let modes       = ["None","Emoji simple","Emoji gradient","Emoji blend","One color","Saved Color","Reset Colors","Test","Soup Alphabeth","Moving Gradients","Changing colors"];
        let mode        = 1;
        const NoneMode=0;
               ...
               case 10:
                 {
                   ...
                   node.style.animation    = "change-colors 2s  infinite  linear running";
                   node.style.borderWidth  = "4px";
                   node.style.borderImage     = "";
                   node.style.backgroundImage = "";
            ...
            for(let m of modes)
              {
                ...
                let option             = document.createElement("p");
                 ...
                 option.addEventListener("click",function(index,optionsdiv)
                                        {
              ...
              switchTheStyle();
                 ...
                 }.bind(null,index,optionsdiv),false);
