// ==UserScript==
// @name        Sorting for Dead Elements3
         ...
         targetDiv.textContent="";
            ...
            for(let element of matched)
              ...
              clone.addEventListener("mouseover",(e)=>{ //console.log("mouse over");
                    ...
                    timeout = setTimeout(()=>{ makeContextMenu(clone,e);}, 1000);
...
function checkChanges()
  ...
  function makeContextMenu(item,e)
  {
    let parent=document.querySelector(".container");
    let conMenu=document.createElement("div");
    conMenu.classList.add("contextMenu");
     //console.log("make context menu");
    // console.log(e.clientX,e.clientY,e.target);
    conMenu.style.overflow="auto";
    conMenu.style.zIndex="1000";
    conMenu.style.position="absolute";
    conMenu.style.top=e.clientY.toString()+"px";
    conMenu.style.left=e.clientX.toString()+"px";

    conMenu.style.backgroundColor="var(--background-color)";



    let checkZombie=document.createElement("input");
     let label=document.createElement("label");
       checkZombie.id="checkZombie";
       checkZombie.style.width="10px";
       checkZombie.style.height="10px";
       label.htmlFor="checkZombie";

    if(isZombie(item.childNodes[1].textContent.trim()))
      {
        label.innerHTML="Is Zombie";
        checkZombie.checked=true;
      }else
        {
         label.innerHTML="Not Zombie";
            checkZombie.checked=false;
        }
     conMenu.addEventListener("mouseout",(e)=>{

                            timeout2= setTimeout(()=>{
                               if(document.querySelector(".container").contains(document.querySelector(".contextMenu")))
                              document.querySelector(".container").removeChild(document.querySelector(".contextMenu"))

                              ;}, 1000);

                        });

         conMenu.addEventListener("mouseover",(e)=>{
    ...
    checkZombie.type="checkbox";
   checkZombie.addEventListener("change",()=>{
                               parent.removeChild(conMenu);
                                     renderer(matchFunction);
                          if(checkZombie.checked)
                                {
   ...
   //  checkZombie.style,display="none";
    conMenu.appendChild(checkZombie);
