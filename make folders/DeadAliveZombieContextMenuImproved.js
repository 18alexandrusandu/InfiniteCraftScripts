...
function checkChanges()
  ...
  function makeContextMenu(item,e, options={colorB:"#54C571",height:40,borderWidth:2,widthButton:50
                                            ,heightButton:20,borderWidthButton:1,radius:4,
                                            minWidth:100,xOffset:120,xOffsetButton:20,paddingButton:1,duration:1},zIndex=1000)
  {
   ...
   checkZombie.addEventListener("change",()=>{
                          ...
                          if(checkZombie.checked)
                                {  span.style.translate=options.xOffsetButton.toString()+"px 0px";
                                  ...
                                  setTimeout(()=>renderer(matchFunction),options.duration*1000);}
                                );
   ...
   //  checkZombie.style,display="none";
    ...
    conMenu.appendChild(textSpan);
         ...
         conMenu.addEventListener("mouseleave",(e)=>{
                        console.log("MOUSE OUT!");
                        setTimeout(()=>{
                               while(document.querySelector(".container").contains(document.querySelector(".contextMenu")))
